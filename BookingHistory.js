...
const pnrno = parseURL.searchParams.get("pnrno");
const Qty = parseURL.searchParams.get("Qty");
const total = parseURL.searchParams.get("total");
...
row.insertCell(0).innerHTML = pnrno;
row.insertCell(1).innerHTML = json.flights[id].name;
row.insertCell(2).innerHTML = total;
row.insertCell(3).innerHTML = Qty;
row.insertCell(4).innerHTML = "2024-01-02";
row.insertCell(5).innerHTML = json.flights[id].departureDate;
row.insertCell(6).innerHTML = `<button type="button" id="cancel${pnrno}">Cancel</button>`